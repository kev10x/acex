...
const AdminDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'pending' | 'all' | 'performance' | 'system' | 'usage'>('pending');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      {loading ? (
        ...
        <Suspense fallback={<div className='py-10 text-center text-sm text-slate-500'>Loading...</div>}><UsageDashboard /></Suspense>
      ) : activeTab === 'pending' ? (
        <div>
